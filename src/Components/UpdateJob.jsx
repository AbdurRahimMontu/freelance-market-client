...
const handleSubmitPut=(e)=>{
  ...
  fetch(`http://localhost:3000/updateJobs/${singleData._id}`,{
    method:"PUT",
    headers:{
 ...
 <div className="bg-base-300">
      ...
      <div className=" card  w-full max-w-md shrink-0 shadow-2xl">
        ...
        <select defaultValue={singleData.category} name="category" className="select appearance-none w-full">
            ...
            <textarea className="textarea h-24 w-full" placeholder="Summary" name="summary" defaultValue={singleData.summary}></textarea>
